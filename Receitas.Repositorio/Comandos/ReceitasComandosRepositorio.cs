    ...
    public class ReceitasComandosRepositorio : IReceitasComandosRepositorio
    {
        ...
        public async Task<ReceitaDto> InserirReceita(InserirReceitaRequest receita)
        {
            ...
            return response.Models.Select(r => new ReceitaDto
            {
                ...
                Nome = r.Nome,
                Imagem = r.Imagem ?? "https://images.unsplash.com/photo-1557499305-bd68d0ad468d?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1262"
            }).FirstOrDefault()!;
        }
